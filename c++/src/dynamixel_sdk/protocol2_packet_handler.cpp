...
int Protocol2PacketHandler::write_Vmode(PortHandler *port, uint16_t address, uint16_t data[], uint8_t *error)
{
...
int Protocol2PacketHandler::txRxPacket_Vmode(PortHandler *port, uint8_t *txpacket, uint8_t *rxpacket, uint8_t *error)
{
  int result = COMM_TX_FAIL;
...
int Protocol2PacketHandler::txPacket_Vmode(PortHandler *port, uint8_t *txpacket)
{
  //uint8_t checksum               = 0;
...
int Protocol2PacketHandler::rxPacket_Vmode(PortHandler *port, uint8_t *rxpacket)
{
  int     result         = COMM_TX_FAIL;
...
int Protocol2PacketHandler::readTxRx_Vmode(PortHandler *port, uint16_t address, uint16_t *data, uint8_t *error)
{
